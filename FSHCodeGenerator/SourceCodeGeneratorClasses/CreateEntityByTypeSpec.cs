...
{
    public CreateEntityByTypeSpec(string filesavelocation, string pathtobasicsources, string stringnamespace, string entity, string entitynameplural, string validatortype, string validatorname)
    {
