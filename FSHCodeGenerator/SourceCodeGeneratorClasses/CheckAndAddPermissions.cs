...
{
    public CheckAndAddPermissions(string pathtobasicsources, string pathtopermissions, Dictionary<string, string> newentities, string permissionsnamespace)
    {
        ...
        foreach (var eKey in newentities)
        {
            ...
            if (canaddpermissions)
            {
                ...
                FSHPermissionstxt = FSHPermissionstxt +  "new(\"View " + eKey.Value + "\", FSHAction.View, FSHResource." + eKey.Value + ", IsBasic: true),";
